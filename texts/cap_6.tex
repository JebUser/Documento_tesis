...
\begin{tabular}{|l|p{3cm}|p{5.2cm}|p{5.2cm}|}
\hline
\textbf{RF} & \textbf{Nombre} & \textbf{Criterio de éxito} & \textbf{Validación (Observación/ Usuario/ Profesional)} \\
\hline
RF-01 & Menú de inicio en VR & El usuario logra interactuar con los botones del menú para iniciar la experiencia o configurar opciones. & Se observa si el usuario comprende y navega el menú inicial sin ayuda. Validación con usuario y profesional. \\
\hline
RF-02 & Selector de dificultad & El sistema carga la escena correspondiente al nivel de dificultad seleccionado por el usuario. & Se observa si el usuario puede elegir el nivel de dificultad. Validación con usuario y profesional. \\
\hline
RF-03 & Narrativa con audio y subtítulos & El audio se reproduce sincronizado con los subtítulos y el usuario mantiene la atención en el relato. & Se verifica si el usuario comprende la historia a través de audio y subtítulos. Validación con usuario y profesional. \\
\hline
RF-04 & Preguntas contextuales previas a minijuegos & El sistema presenta la pregunta y permite al usuario seleccionar una respuesta, validando si es correcta o incorrecta. & Se observa si el usuario responde correctamente a las preguntas antes de los minijuegos. Validación con usuario y profesional. \\
\hline
RF-05 & Guía audiovisual para minijuegos & El usuario comprende la mecánica del minijuego tras observar la guía y procede a realizar la actividad. & Se observa si el usuario comprende la guía antes de cada minijuego. Validación con usuario y profesional. \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{|l|p{3cm}|p{5.2cm}|p{5.2cm}|}
\hline
\textbf{RNF} & \textbf{Nombre} & \textbf{Criterio de éxito} & \textbf{Validación (Observación/ Usuario/ Profesional)} \\
\hline
RNF-01 & Accesibilidad & Los elementos visuales presentan un contraste suficiente para ser distinguidos por usuarios con baja visión. & Se observa si los usuarios distinguen claramente los elementos visuales. Validación con usuario y profesional. \\
\hline
RNF-02 & Eficiencia de Desempeño & La aplicación mantiene una tasa de cuadros estable y ningún usuario reporta mareos o efectos asociados a baja fluidez. & Se observa fluidez y ausencia de interrupciones durante la sesión. Validación con profesional. \\
\hline
RNF-03 & Usabilidad & El usuario identifica correctamente los objetivos y zonas de interacción gracias a las guías visuales y auditivas. & Se observa si los usuarios identifican y siguen los indicadores y guías. Validación con usuario y profesional. \\
\hline
RNF-04 & Fiabilidad & El usuario no logra atravesar los límites del área de juego ni acceder a zonas no permitidas. & Se observa si el usuario no puede acceder a zonas no permitidas. Validación con profesional. \\
\hline
RNF-05 & Portabilidad & La aplicación se instala y ejecuta correctamente en modo autónomo en distintos dispositivos de las serie Meta Quest sin errores de compatibilidad. & Se verifica ejecución estable en el dispositivo objetivo. Validación con profesional. \\
\hline
RNF-06 & Mantenibilidad & La estructura del proyecto permite identificar y modificar componentes específicos (escenas, prefabs) sin afectar el funcionamiento global. & Revisión técnica de la arquitectura del proyecto en Unity. Validación con equipo de desarrollo, director de tesis y los profesionales del INCS. \\
\hline
\end{tabular}
\end{table}
...
\begin{itemize}
    \item \textbf{Formulario para profesionales:} \href{https://docs.google.com/forms/d/e/1FAIpQLSfbVQhvDyd-tr0zeXBdOxiLSyvpOo0uXB3eAW-09ZCh5Qfq7Q/viewform?usp=sharing&ouid=107011505231446676975}{Enlace al formulario (Google Forms)}
    \item \textbf{Formulario para niñas y niños:} \href{https://docs.google.com/forms/d/e/1FAIpQLSfetsa-WDREubyR6fi5Z5OsFUosWwQmB66EWeFfrHLB5tygmg/viewform?usp=sharing&ouid=107011505231446676975}{Enlace al formulario (Google Forms)}
\end{itemize}
...
\begin{itemize}
    ...
    \item Contestó todas las preguntas del juego correctamente en el primer intento.
    \item Comprendió el relato y el objetivo del mismo.
